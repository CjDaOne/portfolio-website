...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Dynamically reference your system organization ID from environment variables
    const targetOrganizationId = import.meta.env.VITE_DEFAULT_ORG_ID || '90499f6d-43ee-4f0d-b097-3da31bacf421';

    try {
      // Invoke your secure Postgres security definer function via RPC directly
  ...
  return (
    // ... JSX structural code stays perfectly identical ...
