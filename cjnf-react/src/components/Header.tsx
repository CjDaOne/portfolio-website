        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex items-center space-x-6 text-sm font-medium">
              ...
              <li><a href="?view=login" className="hover:text-blue-300 transition">Client Portal</a></li>
          ...
          <button 
            className="md:hidden text-white focus:outline-none p-2 min-w-[44px] min-h-[44px] flex items-center justify-center z-50"
            onClick={() => setMenuOpen(!menuOpen)}
            aria-label="Toggle menu"
          >
            <i className={`fas ${menuOpen ? 'fa-times' : 'fa-bars'} text-2xl block w-6 h-6 text-center`} />
          </button>
        </div>
        ...
        {menuOpen && (
          <nav className="md:hidden mt-4 pb-4 border-t border-blue-700/60">
            <ul className="flex flex-col space-y-4 pt-4 text-base font-medium">
              ...
              <li><a href="?view=login" className="block hover:text-blue-300 transition py-1" onClick={() => setMenuOpen(false)}>Client Portal</a></li>
